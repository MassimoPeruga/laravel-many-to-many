...
@section('content')
    <div class="container py-4">
        ...
        <div class="row">
            <div class="col-12">
                <h2>Progetti con tecnologia {{ $technology['title'] }} </h2>
            </div>
            <div class="col text-end mb-3">
                <a href="{{ route('admin.technologies.index') }}" type="button" class="btn btn-info align-self-center">
                    Torna alla tabella delle tecnologie
                </a>
                <a href="{{ route('admin.technologies.edit', $technology) }}" type="button" class="btn btn-warning mx-2">
                    Modifica questa tecnologia
                </a>
                @include('shared.modal', [
                    'modalRoute' => 'admin.technologies.destroy',
                    'itemToDelete' => "$technology[slug]",
                    'itemName' => "$technology[title]",
                    'modalButton' => 'questa tecnologia',
                    'modalWarning' => true,
                ])
            </div>
        </div>
